...
var = list(st0 = "st0", st1 = "st1", ENV1 = "ENV1", ENV2 = "ENV2", lik = "predicted", Ha = "Ha", Hv = "Hv")
...
coarse_veget= anneal(model = model, par = pars, var = var, source_data = data, 
dep_var = "st1", pdf = PDF, par_initStep = par_initStep, par_testFct = testBounds, max_iter = 100, initial_temp = 3, note = "", progress = TRUE, display=FALSE, support = FALSE, min_change = 1, min_drops = 10)

#
#par = coarse_veget$best_pars
save(coarse_veget, file="../estimated_params/coarse_integrated_veget100")
write.table(coarse_veget$best_pars,"../estimated_params/coarse_integrated_veget100.txt")
