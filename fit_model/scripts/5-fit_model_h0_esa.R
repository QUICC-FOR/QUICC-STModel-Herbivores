...
#
save(coarse, file="../estimated_params/coarse_veget_m3")
...
save(coarse_veget, file="../estimated_params/coarse_veget_m3_step2")
save(par_lo, par_hi, file="../estimated_params/coarse_veget_m3_step2_lim")
...
save(coarse_veget, file="../estimated_params/coarse_veget_m3_step3")
save(par_lo, par_hi, file="../estimated_params/coarse_veget_m3_step3_lim")
...
#dep_var = "st1", pdf = PDF, par_lo = par_lo, par_hi=par_hi, max_iter = 10000, initial_temp = 3, min_change = 1, min_drops = 10)
#
#save(coarse, file="../estimated_params/coarse_veget_m3_step4")
#save(par_lo, par_hi, file="../estimated_params/coarse_veget_m3_step4_lim")
#write.table(coarse$best_pars,"../estimated_params/par_veget_m3.txt")
#
#
#
#
