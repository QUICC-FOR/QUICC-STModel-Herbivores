...
coarse= anneal(model = model, par = pars, var = var, source_data = data, 
...
save(coarse, file="../estimated_params/coarse_integrated_herbi100")
write.table(coarse$best_pars,"../estimated_params/coarse_integrated_herbi100.txt")
